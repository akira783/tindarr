...
At runtime ``tindarr.storage.migrate`` passes an open connection through
...
from tindarr.storage.db import create_sync_engine
...
def _main() -> None:
    ...
    url = context.config.get_main_option("sqlalchemy.url") or "sqlite:///data/tindarr.db"
