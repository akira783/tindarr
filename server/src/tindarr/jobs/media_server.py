"""The background work that keeps Tindarr and the media server in step.
...
- **the user sync**, hourly and 60 s after startup: who was removed, disabled or
  demoted on the media server (``tindarr.auth.sync``);
...
from tindarr.auth.brokered import QuickConnectFlow
