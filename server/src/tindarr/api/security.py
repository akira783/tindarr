...
3. the session **and** its user are loaded on every request, so a revocation or a
   disable takes effect at once (``tindarr.auth.sessions``);
...
from tindarr.api.context import RequestContext, request_context
from tindarr.api.cookies import CookieTransport, cookie_transport
...
from tindarr.auth.sessions import Authenticated
from tindarr.auth.tokens import tokens_equal
from tindarr.core.errors import ProblemError
from tindarr.core.net import normalize_origin
from tindarr.storage.sessions import Session, SessionKind
