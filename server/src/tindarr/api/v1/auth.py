...
(``tindarr.auth.signin``); what differs is only what this layer does with the result,
...
from tindarr.api.cookies import (
    CookieTransport,
...
from tindarr.api.security import (
    Authenticator,
    Context,
    SharedSession,
    Transport,
...
from tindarr.api.useragent import console_device
...
from tindarr.auth.handles import Binding, HandlePurpose
from tindarr.auth.methods import AuthMethod
from tindarr.auth.sessions import CookieGrant
from tindarr.auth.signin import Caller, ConsoleSignIn
