...
from tindarr.auth.mediaserver import (
    SETTING_FOR_FIELD,
...
from tindarr.auth.setupcode import (
    generate_setup_code,
    matches,
    read_setup_code,
    remove_setup_code,
...
from tindarr.ports.media_server import ConnectionCheck, MediaServerKind, MediaUser
...
class SetupService:
    ...
    async def reset(self) -> Path:
        ...
        The recovery path of ``tindarr media-server reset`` (docs/auth.md, section 3),
