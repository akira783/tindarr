...
Tindarr session outlives it. So once an hour Tindarr asks the media server who its
...
- ``media_server_admin`` is **cleared** when the media server no longer says
  ...
  Tindarr lasts until that user signs in again (ADR 0010);
...
class UserSync:
    """Reconciles the Tindarr users with the media server's."""
