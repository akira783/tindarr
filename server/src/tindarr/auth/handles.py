...
from tindarr.auth.ratelimit import SlidingWindow
...
from tindarr.ports.plextv import PlexPin
...
class HandleRegistry:
    ...
    def reserving(
        ...
        answer: otherwise a refused caller still makes Tindarr create a plex.tv PIN or
