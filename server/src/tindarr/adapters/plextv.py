...
Only the classic PIN flow is used. Tindarr never registers a JWK with plex.tv: doing so
...
from tindarr.ports.media_server import normalize_server_id
from tindarr.ports.plextv import PlexAccount, PlexPin, PlexResource

PLEX_TV_URL: Final = "https://plex.tv"
PRODUCT: Final = "Tindarr"
#: Where the user approves a PIN. ``context[device][product]`` names Tindarr on the page.
