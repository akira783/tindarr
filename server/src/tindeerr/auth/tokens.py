...
``tindeerr/v1/jwt-signing``. Their expiry is checked against the injected clock rather
...
from tindeerr.auth.errors import token_expired, unauthorized
...
AUDIENCE: Final = "tindeerr-api"
ISSUER_PREFIX: Final = "tindeerr:"
